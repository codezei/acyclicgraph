...
document.addEventListener('click', (e)=> {
    ...
    else if (e.target.parentElement.classList.contains('poligon-popup') || e.target.parentElement.parentElement.classList.contains('poligon-popup')) {
    } else if (e.target.classList.contains('.strucrure-poligon')) {
      e.preventDefault()
      let popup = document.querySelector('.poligon-popup.open')
      popup.classList.remove('open')
    } 
    ...
    //   console.log('1')
    //   let a = document.querySelector('.poligon-popup.open .flag-href');
    //   a.href = e.target.dataset.href;
    //   a.innerHTML = e.target.dataset.href;
    // } else if (e.target.parentElement.dataset.href) {
    //   let a = document.querySelector('.poligon-popup.open');
    //   console.log(a)
    //   a.href = e.target.dataset.href;
    //   a.innerHTML = e.target.dataset.href;
    // }
})
// let poligon = document.querySelector('.structure-poligon');
